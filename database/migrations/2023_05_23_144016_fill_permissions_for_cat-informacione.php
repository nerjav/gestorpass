...
class FillPermissionsForCatInformacione extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCatInformacione constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cat-informacione',
            'admin.cat-informacione.index',
            'admin.cat-informacione.create',
            'admin.cat-informacione.show',
            'admin.cat-informacione.edit',
            'admin.cat-informacione.delete',
            'admin.cat-informacione.bulk-delete',
        ]);
