...
class FillPermissionsForServidor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServidor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.servidor',
            'admin.servidor.index',
            'admin.servidor.create',
            'admin.servidor.show',
            'admin.servidor.edit',
            'admin.servidor.delete',
            'admin.servidor.bulk-delete',
        ]);
