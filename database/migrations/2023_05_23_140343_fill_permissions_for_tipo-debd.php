...
class FillPermissionsForTipoDebd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipoDebd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipo-debd',
            'admin.tipo-debd.index',
            'admin.tipo-debd.create',
            'admin.tipo-debd.show',
            'admin.tipo-debd.edit',
            'admin.tipo-debd.delete',
            'admin.tipo-debd.bulk-delete',
        ]);
