...
class FillPermissionsForCredenciale extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCredenciale constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.credenciale',
            'admin.credenciale.index',
            'admin.credenciale.create',
            'admin.credenciale.show',
            'admin.credenciale.edit',
            'admin.credenciale.delete',
            'admin.credenciale.bulk-delete',
        ]);
