...
class FillPermissionsForTipodeconexion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipodeconexion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipodeconexion',
            'admin.tipodeconexion.index',
            'admin.tipodeconexion.create',
            'admin.tipodeconexion.show',
            'admin.tipodeconexion.edit',
            'admin.tipodeconexion.delete',
            'admin.tipodeconexion.bulk-delete',
        ]);
