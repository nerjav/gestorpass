...
//Route::get('/descifrar', 'App\Http\Controllers\Admin\CredencialesController@descifrar')->name('descifrar');
Route::get('/descifrar', 'CredencialesController@descifrar')->name('descifrar');
